    ...
    <div className='container-fluid py-lg-5 py-sm-4 py-5'>
      <div className="container d-flex flex-column gap-lg-4 gap-sm-4 gap-4">
        ...
        <div className="productsSection">
          <div className="row justify-content-center align-items-center gy-lg-0 gy-sm-4 gy-4">
            {products.map((item, index) => (
              <div className="col-lg-3 col-sm-6 col-12" key={index}>
                <div className='productContent d-flex flex-column align-items-lg-start align-items-sm-center  align-items-start gap-lg-1 gap-sm-1 gap-2'>
                  ...
                  <div className="productRating d-flex align-items-lg-start align-items-lg-center">
